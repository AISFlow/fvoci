...
use crate::api::dto::{
    ...
    PublicBrandingOutput, PublicSettingsValues, PutAttachmentPartResponse,
...
#[openapi(
    ...
    tags(
        ...
        (name = "admin", description = "Instance administration, settings and branding"),
        (name = "legal", description = "Legal documents and consents"),
    )
)]
pub struct ApiDoc;
