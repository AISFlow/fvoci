...
const PROBLEM_TITLES: Record<string, I18nKey> = {
  ...
  "limit.storage": "workspace storage limit reached",
  "limit.upload": "upload size limit reached",
  ...
  anchor_not_in_target_list: "anchor not in target list",
  open_time_entry_exists: "open time entry exists",
  status_has_tasks: "status has tasks",
  workflow_status_limit: "workflow status limit reached",
